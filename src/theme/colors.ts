...
export const scanner = {
  ...
  /** Semi-transparent result tints — artwork remains visible beneath. */
  validOverlay: 'rgba(57, 255, 20, 0.88)',
  alreadyUsedOverlay: 'rgba(255, 176, 32, 0.88)',
  invalidOverlay: 'rgba(255, 59, 59, 0.88)',
  wrongEventOverlay: 'rgba(255, 59, 59, 0.88)',
  voidedOverlay: 'rgba(46, 49, 53, 0.92)',
  cameraScrim: 'rgba(8, 8, 8, 0.28)',
  footerPillBackground: 'rgba(0, 0, 0, 0.42)',
