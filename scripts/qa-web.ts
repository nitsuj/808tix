...
const SUMMARY_ROWS: Array<{
  ...
  {
    testTitle: 'public homepage shows upcoming events CTA',
    route: '/',
    screenshot: '10-public-home-events.png',
    requiredScreenshot: true,
  },
  {
    testTitle: 'public event buy page shows ticket type and price',
    route: '/events/{QA_EVENT_ID}/buy',
    screenshot: '11-public-event-buy-ticket-price.png',
    requiredScreenshot: true,
  },
  {
    testTitle: 'public event buy page shows quantity and checkout CTA',
    route: '/events/{QA_EVENT_ID}/buy',
    screenshot: '12-public-event-buy-quantity-checkout.png',
    requiredScreenshot: true,
  },
  {
    testTitle: 'organizer ticket type price input is visible',
    route: '/events/{QA_EVENT_ID} (ticket types)',
    screenshot: '13-organizer-ticket-type-price.png',
    requiredScreenshot: true,
  },
  {
    testTitle: 'manual ticket share copy is honest',
    route: '/events/{QA_EVENT_ID}/issue',
    screenshot: '14-manual-ticket-share-copy.png',
    requiredScreenshot: true,
  },
];
